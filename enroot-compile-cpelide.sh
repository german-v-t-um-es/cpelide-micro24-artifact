...
enroot start --rw --mount $(pwd):$(pwd) cpelide bash -c "cd /home/germanvt/MULTIGPU/cpelide-micro24-artifact/gem5_multigpu/multigpu_benchmarks/square; make square_m"
